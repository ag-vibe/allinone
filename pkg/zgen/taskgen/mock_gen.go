...
func (m *MockExecutorInterface) ExecuteAutoIncrementCounter(ctx context.Context, task worker.Task, params *AutoIncrementCounterParameters) error {
	m.ctrl.T.Helper()
...
func (m *MockExecutorInterface) ExecuteIncrementCounter(ctx context.Context, task worker.Task, params *IncrementCounterParameters) error {
	m.ctrl.T.Helper()
